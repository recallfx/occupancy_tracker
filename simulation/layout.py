...
BASE_LAYOUT = {
    ...
    "sensors": [
        ...
        },  # Entrance <-> Backyard (Assuming 'therace' is terrace/back)
        # Cameras
        {
            "id": "person_front_left_camera",
            "x": 100,
            "y": 50,
            "type": "camera_person",
            "area": "frontyard",
